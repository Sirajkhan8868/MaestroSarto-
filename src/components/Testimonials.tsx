...
const testimonials = [
  {
    ...
    quote: "The attention to detail and quality of craftsmanship at Maestro Sarto is unmatched. My suits not only fit perfectly but make me feel confident in every business meeting.",
    imageSrc: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&q=80",
  },
  {
    name: "Michael Thomas",
    title: "Attorney",
    quote: "I've been a client for over 5 years, and Maestro Sarto consistently exceeds my expectations. The personal service and expert advice on fabric and style selection is invaluable.",
    imageSrc: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&q=80",
  },
  {
    name: "James Wilson",
    title: "Finance Director",
    quote: "From my wedding tuxedo to my everyday business attire, Maestro Sarto ensures I always look my best. Their craftsmanship stands the test of time.",
      ...
      <div className="">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-gray-300 text-lg">
            Don't just take our word for it. Here's what our clients have to say about their experience with Maestro Sarto.
          </p>
        </div>
