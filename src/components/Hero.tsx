      ...
      <div className="container mx-auto px-4 text-white relative z-20 flex flex-col items-center justify-center text-center">
        <div className="max-w-3xl animate-fade-in">
          ...
          <p className="text-lg md:text-xl font-light mb-6 tracking-[0.1rem] leading-relaxed text-tailor-white">
            Welcome to our boutique tailoring studio in Camps Bay, Cape Town where ocean views meet timeless style. We specialize in bespoke and made-to-measure suits, expertly crafted to reflect your individuality. From precision alterations to unique custom pieces, every garment is tailored to perfection  because you deserve nothing less than excellence.</p>
