            ...
            <div className="">
                ...
                <div className="text-center">
                    ...
                    <p className="font-medium text-bold text-base text-gray-500 leading-relaxed">
                        We believe custom clothing experiences should be convenient and affordable to customers. Our team of stylist, designers & talented tailors worked together to get <br /> you the best experience in getting your custom clothing online.
                    </p>
