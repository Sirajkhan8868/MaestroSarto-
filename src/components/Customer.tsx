            ...
            <div className="container mx-auto">
                ...
                <div className="text-center">
                    ...
                    <p className="font-medium text-bold text-base text-gray-500 leading-relaxed">
                        We believe custom clothing experiences should be convenient and affordable to customers. Our team of stylist, designers & talented tailors worked together to get <br></br> you the best experience in getting your custom clothing online.
                    </p>

                    <h6 className="text-center mt-8 text-xl md:text-2xl font-light text-black-700 whitespace-nowrap overflow-x-auto max-w-full px-4 tracking-wide leading-snug">
                ...
                <div className="flex flex-col md:flex-row gap-10 items-center justify-center">
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-center gap-8  py-8 rounded-md">
                        ...
                        <div className="text-center bg-gray-100">
                            ...
                            <p className="mb-4">BESPOKE SUITS
                        ...
                        <div className="text-center bg-gray-100">
                            ...
                            <h5 className="text-center mt-4 text-lg md:text-2xl font-medium text-black-500 mt-4 mb-2 leading-tight tracking-wide">
                                TAILOR MADE
                            </h5>

                            <p className="mb-4">WEDDING SUITS
                            </p>
                        </div>
                    </div>
