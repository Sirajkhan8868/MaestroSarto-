    ...
    <section id="about" className="section bg-white py-6">
      <div className="container mx-auto">
        ...
        <div className="text-center">
          ...
          <h6 className="text-center text-3xl font-normal text-gray-800 mb-10 leading-snug">
        ...
        <div className="flex flex-col md:flex-row gap-10 items-center justify-center">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-8  py-8 rounded-md">
            ...
            <div className="text-center bg-gray-100">
              ...
              <h1 className="text-xl font-semibold text-gray-800 my-5">VISIT OUR DESIGN STUDIO IN DUBAI
              </h1>
            ...
            <div className="text-center bg-gray-100">
              ...
              <h1 className="text-xl font-semibold text-gray-800 my-5">BOOK A HOME VISIT WITH OUR STYLIST
              </h1>
              <button className="bg-black text-white mb-5 text-gray-800 font-semibold py-2 px-6 rounded-lg shadow-md hover:bg-gray-100 transition duration-300">
                Book Now
              </button>
            ...
            <div className="text-center bg-gray-100">
              ...
              <h1 className="text-xl font-semibold text-gray-800 my-5">BOOK A VIRTUAL APPOINTMENT
