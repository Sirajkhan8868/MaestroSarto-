    ...
    <div className="min-h-screen bg-white py-16 px-4">
      ...
      <div className="text-center max-w-4xl mx-auto px-4">
        <h2 className="text-3xl md:text-4xl font-semibold mb-6 text-gray-900">
          TAILORED SUITS IN DUBAI FOR ALL OCCASIONS
        </h2>
        <p className="text-gray-700 leading-relaxed text-lg md:text-xl">
          Bespoke suits for every occasion. At House of Tailors, we specialize in creating custom made suits that are
          tailored to your unique style and preferences. Our tailoring experts can help you create the perfect look for
          your wedding and special event. Experience the art of bespoke tailoring at House of Tailors.
        </p>
      </div>
